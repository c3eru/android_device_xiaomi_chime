...
# Display
$(call inherit-product, hardware/qcom-caf/$(QCOM_HARDWARE_VARIANT)/display/config/display-product.mk)
...
BOARD_DISPLAY_HAL := hardware/qcom-caf/$(QCOM_HARDWARE_VARIANT)/display
